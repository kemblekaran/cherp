...
public class PurchaseServlet extends HttpServlet {
	...
	private String prodPieces = "";
	private String prodKG = "";
	// private String rate = "";
	...
	public void getParaValues(HttpServletRequest request, HttpServletResponse response) {
		...
		driver1 = request.getParameter("driver");
//		driver2 = request.getParameter("driver2");
		cleaner1 = request.getParameter("cleaner");
//		cleaner2 = request.getParameter("cleaner2");
		...
		prodPieces = request.getParameter("prodPieces");
		prodKG = request.getParameter("prodKG");
...
//
			System.out.println("Date : "+date+",product :"+prodName);
//
